...
def simulated_annealing(airplanes, landing_strips, initial_temperature=1000, cooling_rate=0.99, stopping_temperature=0.0001, max_iterations=1000):
    ...
    while temperature > stopping_temperature and iteration < max_iterations:
        new_solution = copy.deepcopy(current_solution)  # Mova esta linha aqui dentro do loop while
